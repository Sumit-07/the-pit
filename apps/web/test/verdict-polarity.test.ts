...
const NON_FIGURE: ReadonlyArray<readonly [string, string]> = [
  ...
  ['.vbar .meter .seg.s6', 'the same ramp, sixth step'],
  ...
  ['.vlines .ln.c', 'the sharpest cut’s rail: a quotation of a deduction'],
  ['.vlines .ln.h', 'the warmest buyer’s rail: a quotation of a first choice'],
